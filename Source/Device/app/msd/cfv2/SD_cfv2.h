...
#define SD_WAIT_CYCLES 10
	...
	#define SD_DE		(MCF_GPIO_SETAN | MCF_GPIO_SETAN_SETAN1)				// Card detection (AN0 input register)
	#define _SD_DE		(MCF_GPIO_DDRAN &= ~MCF_GPIO_DDRAN_DDRAN1)				// Card detection (AN0 direction: input)
	
	#define kSD_Insert 	0
	#define kSD_Desert 	(1<<1)
#endif
#ifdef __MCF52277_H__
	#define SD_DE     	(MCF_EPORT_EPPDR | MCF_EPORT_EPPDR_EPPD1) 				// Card detection (IRQ1 pin input register)
	#define _SD_DE   	(MCF_EPORT_EPDDR &= ~MCF_EPORT_EPPDR_EPPD1)    			// Card detection (IRQ1 pin direction: input)
...
#if(defined(__MCF52259_H__) || defined(__MCF52221_H__))
	#define SD_WR		(MCF_GPIO_SETAN | MCF_GPIO_SETAN_SETAN2)				// Write protection
	#define _SD_WR		(MCF_GPIO_DDRAN &= ~MCF_GPIO_DDRAN_DDRAN2)				// Write protection
	
	#define kSD_WP    	(1<<2)
	#define kSD_WnP   	0
#endif
#ifdef __MCF52277_H__
	#define SD_WR      	(MCF_GPIO_PPDSDR_I2C | MCF_GPIO_PPDSDR_I2C_PPDSDR_I2C0) // Write protection (PI2C0 input register)
	#define _SD_WR     	(MCF_GPIO_PDDR_I2C &= ~MCF_GPIO_PDDR_I2C_PDDR_I2C0)    	// Write protection (PI2C0 direction: input)
