...
CONFIGURATION
=============
  The Workspace contains USB Virtual Camera example with the following configuration:
...
===============
  ...
  2) Select File->Open->Workspace...
     Open the following workspace:
      ...
      Source\Device\app\virtual_camera\iar_ew\kinetis_k21\USB_VIRTUAL_CAMERA.eww
