...
CONFIGURATION
=============
  The Workspace contains USB Audio generator example with the following configuration:
...
===============
  ...
  2) Select File->Open->Workspace...
     Open the following workspace:
      ...
      Source\Device\app\audio_generator\iar_ew\kinetis_k20d7\USB_AUDIO_GEN.eww
