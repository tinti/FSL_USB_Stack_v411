...
CONFIGURATION
=============
  The Workspace contains USB PHDC MULTI example with the following configuration:
...
===============
  ...
  2) Select File->Open->Workspace...
     Open the following workspace:
      ...
      Source\Device\app\phdc_multi_specialization\iar_ew\
      kinetis_k20d7\USB_PHDC_MULTI.eww
