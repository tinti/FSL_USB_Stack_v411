...
=============
  ...
  The example project is compatible with Freescale TWR-L2K board.
  By default, the project is configured to use the J-Link JTAG interface.
 
CONFIGURATION
=============
  The Workspace contains USB Printer example with few configurations.

  RAM Debug L2K:   The example is loaded into internal RAM
  Flash Debug L2K: The example is flashed to embedded flash memory.
...
===============
  ...
  2) Select File->Open->Workspace...
     Open the following workspace:
      ...
      Source\Device\app\printer\iar_ew\kinetis_l2k\USB_PRINTER.eww
