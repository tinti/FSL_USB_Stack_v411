...
=============
  ...
  The example project is compatible with Freescale TWR-L4K board.
...
=============
  ...
  RAM Debug L4K:   The example is loaded into internal RAM
  Flash Debug L4K: The example is flashed to embedded flash memory.
...
===============
  ...
  2) Select File->Open->Workspace...
     Open the following workspace:
      ...
      Source\Device\app\printer\iar_ew\kinetis_l4k\USB_PRINTER.eww
