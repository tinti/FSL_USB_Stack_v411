...
=============
  ...
  RAM Debug K70:   The example is loaded into internal RAM
  Flash Debug K70: The example is flashed to embedded flash memory.
...
===============
  ...
  2) Select File->Open->Workspace...
     Open the following workspace:
      ...
      Source\Device\app\printer\iar_ew\kinetis_k70\USB_PRINTER.eww
