...
CONFIGURATION
=============
  The Workspace contains USB Audio speaker example with the following configuration:
...
===============
  ...
  2) Select File->Open->Workspace...
     Open the following workspace:
      ...
      Source\Device\app\audio_speaker\iar_ew\kinetis_k20d7\USB_AUDIO_SPK.eww
