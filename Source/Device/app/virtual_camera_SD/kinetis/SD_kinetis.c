...
#if (defined MCU_MKL25Z4)
   memcpy((uint_8*)max_blocks_ptr, (uint_8*)&u32MaxBlocks.lword, 4);
   temp_32 = (uint_32)u16BlockSize.u16;
   memcpy((uint_8*)block_size_ptr, (uint_8*)&temp_32, 4);
#else
