...
#define SD_DE                       (GPIOB_PDIR | GPIO_PSOR_PTSO(8))    /*  Card detection (AN0 input register)  */
#define _SD_DE                      GPIOB_PCOR = 1 << 8/* Card detection (AN0 direction: input) */

#define kSD_Insert  0
#define kSD_Desert  (1<<8)
#elif (defined MCU_MK60N512VMD100) || (defined MCU_MK70F12)
#define SD_DE                       (GPIOA_PDIR | GPIO_PSOR_PTSO(27))   /*  Card detection (AN0 input register) */
#define _SD_DE                      GPIOA_PCOR = 1 << 27    /* Card detection (AN0 direction: input)    */

#define kSD_Insert  0
#define kSD_Desert  (1<<27)

#elif defined MCU_MK21D5
#define SD_DE                       (GPIOA_PDIR | GPIO_PSOR_PTSO(17))   /*  Card detection (AN0 input register) */
#define _SD_DE                      GPIOA_PCOR = 1 << 17    /* Card detection (AN0 direction: input)    */

#define kSD_Insert  0
#define kSD_Desert  (1<<17)

#elif defined (MCU_MK40D7) || defined (MCU_MK20D7) 
#define SD_DE                       (GPIOE_PDIR | GPIO_PSOR_PTSO(27))   /*  Card detection (AN0 input register) */
#define _SD_DE                      GPIOE_PCOR = 1 << 27    /* Card detection (AN0 direction: input)    */

#define kSD_Insert  0
#define kSD_Desert  (1<<27)

#elif defined MCU_MKL25Z4
#define SD_DE	(GPIOC_PDIR | GPIO_PSOR_PTSO(5))   /*  Card detection (AN0 input register) */
#define _SD_DE	GPIOC_PCOR = 1 << 5    /* Card detection (AN0 direction: input)    */

#define kSD_Insert 0
#define kSD_Desert (1 << 5)
...
#if (defined __MK_xxx_H__)
#define SD_WR                       GPIOE_PSOR | GPIO_PSOR_PTSO(5)) /* Card detection (AN0 input register) */
#define _SD_WR                      GPIOE_PSOR |= 1 << 5    /* Card detection (AN0 direction: input)    */
