...
=============
  ...
  The example project is compatible with Freescale TWR-K21D50M board.
  By default, the project is configured to use the P&E OS-JTAG interface.
 
CONFIGURATION
=============
  The Workspace contains USB HID vitural camera using SD card with few configurations.

  Flash Debug K21: The example is flashed to embedded flash memory.
...
===============
  ...
  2) Select File->Open->Workspace...
     Open the following workspace:
      ...
      Source\Device\app\virtual_camera_SD\iar_ew\kinetis_k21\USB_VIRTUAL_CAMERA_SD.eww

  3) Connect the P&E OS-JTAG hardware interface
