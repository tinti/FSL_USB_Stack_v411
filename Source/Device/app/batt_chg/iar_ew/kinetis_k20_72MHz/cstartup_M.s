...
__vector_table
        ...
        DCD     0           			  ;28:  Reserved
        DCD     CAN0_MESS_IRQHandler      ;29:  CAN 0 OR'ed Message buffer (0-15)
        DCD     CAN0_BUS_OFF_IRQHandler   ;30:  CAN 0 Bus Off
        DCD     CAN0_ERR_IRQHandler       ;31:  CAN 0 Error
        DCD     CAN0_TW_IRQHandler        ;32:  CAN 0 Transmit Warning
        DCD     CAN0_RW_IRQHandler        ;33:  CAN 0 Receive Warning
        DCD     CAN0_WAKE_UP_IRQHandler   ;34:  CAN 0 WakeUp
        DCD     I2S0_TX_IRQHandler        ;35:  I2S 0 Transmit
        DCD     I2S0_RX_IRQHandler        ;36:  I2S 0 Receive
        DCD     0      					  ;37:  Reserved
        DCD     0   					  ;38:  Reserved
        DCD     0       				  ;39:  Reserved
        DCD     0        				  ;40:  Reserved
        ...
        DCD     0   					  ;42:  Reserved
        DCD     0      					  ;43:  Reserved
        DCD     UART0_LON_IRQHandler      ;44:  UART 0 LON
        ...
        DCD     USBDCD_ISR                ;74:  USB Charger Detect interrupt
        DCD     0                         ;75:  Reserved
        DCD     0                         ;76:  Reserved
        DCD     0                         ;77:  Reserved
        DCD     0                         ;78:  Reserved
        ...
        DCD     0            		  ;86:  Reserved
        DCD     VbusDetect_ISR            ;87:  PORT A interrupt
        DCD     PORTB_IRQHandler          ;88:  PORT B interrupt
        DCD     IRQ_ISR_PORTC             ;89:  PORT C interrupt
