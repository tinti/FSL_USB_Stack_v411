...
#define VIDEO_INPUT_TERMINAL_ONLY_DESC_SIZE   (0x11)
#define VIDEO_OUTPUT_TERMINAL_ONLY_DESC_SIZE  (0x09)
...
#define VIDEO_ENDPOINT_PACKET_SIZE (256)

#define USB_AUDIO_DESCRIPTOR      (0x25)
#define USB_HID_DESCRIPTOR        (0x21)
#define USB_REPORT_DESCRIPTOR     (0x22)

#define USB_MAX_SUPPORTED_INTERFACES       (5)
...
#define COMP_CLASS_UNIT_COUNT           (3)
...
typedef const struct _USB_VIDEO_AUDIO_UNITS
{
    /* Number of entities of this application */
    uint_8         count;
    /* Array of entities of this application */
