...
CONFIGURATION
=============
  The Workspace contains USB COMPOSITE DEVICE example with few configurations.
...
===============
  ...
  2) Select File->Open->Workspace...
     Open the following workspace:
      ...
      Source\Device\app_composite\hid_audio_video\iar_ew\kinetis_k60\USB_HID_AUDIO_VIDEO.eww
