...
const __declspec(vectortable) tVectorTable __vector_table = { /* Interrupt vector table */
...
#endif
#ifdef _USB_BATT_CHG_APP_H_  
   (tIsrFunc)USBDCD_ISR,          	  /* 0x5A  0x00000168   -   ivINT_USBDCD                   unused by PE */
#else
...
#if (defined _USB_BATT_CHG_APP_H_)&& (defined MCU_MK60N512VMD100)
   (tIsrFunc)VbusDetect_ISR,          /* 0x67  0x0000019C   -   ivINT_PORTA                    unused by PE */
   /* Use IRQ_ISR_POTRA for bus reset detecting with TWR_K60*/
#else
   (tIsrFunc)IRQ_ISR_PORTA,           /* 0x67  0x0000019C   -   ivINT_PORTA                    unused by PE */
#endif
#if (defined _USB_BATT_CHG_APP_H_) && ((defined MCU_MK40N512VMD100) ||  (defined MCU_MK53N512CMD100)) 
   ...
   /* Use IRQ_ISR_POTRB for bus reset detecting with TWR_K40 and TWR_K53 */
#endif
#if (defined MCU_MK40N512VMD100) ||  (defined MCU_MK53N512CMD100) 
