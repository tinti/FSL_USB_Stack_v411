...
#ifdef USE_PIT0
   (tIsrFunc)PIT0_ISR,           	  /* 0x54  0x00000150   -   ivINT_PIT0                     PIT0_ISR     */
#else 
...
#ifdef USE_IRQ
   (tIsrFunc)IRQ_ISR_PORTA,           /* 0x67  0x0000019C   -   ivINT_PORTA                    IRQ_ISR_PORTA*/
#else
...
#ifdef USE_IRQ
   (tIsrFunc)IRQ_ISR_PORTC,           /* 0x69  0x000001A4   -   ivINT_PORTC                	   IRQ_ISR_PORTC*/
#else
...
#ifdef USE_IRQ
   (tIsrFunc)IRQ_ISR_PORTE,           /* 0x6B  0x000001AC   -   ivINT_PORTE                    IRQ_ISR_PORTE*/
#else
   (tIsrFunc)Cpu_Interrupt,           /* 0x6B  0x000001A4   -   ivINT_PORTE                    unused by PE */
#endif
