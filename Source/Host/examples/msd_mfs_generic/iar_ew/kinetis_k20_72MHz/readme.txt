...
CONFIGURATION
=============
  The Workspace contains USB MSD FAT-FS GENERIC Host example with the following configuration:
...
===============
  ...
  2) Select File->Open->Workspace...
     Open the following workspace:
      ...
      Source\Host\examples\msd_mfs_generic\iar_ew\kinetis_k20d7\MSD_FAT_FS_GENERIC.eww
