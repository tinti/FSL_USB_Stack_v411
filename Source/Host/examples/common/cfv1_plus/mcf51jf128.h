...
#define MCU_MEM_MAP_VERSION 0x0001u
...
/*! \addtogroup Interrupt_vector_adresses Interrupt vector adresses */
/*! \{ */

/*! Interrupt Vector Adresses Calculation Macro */

#define GetIntVectAddr(Vnum) (Vnum * 4)

/*! \} */ /* end of group Interrupt_vector_adresses */
...
typedef struct FTM_MemMap {
  ...
  struct {                                         /* offset: 0x5, array step: 0x3 */
    ...
    union {                                          /* offset: 0x6, array step: 0x3 */
      struct {                                         /* offset: 0x6, array step: 0x3 */
        uint8_t CVH;                                     /*!< Channel Value High, array offset: 0x6, array step: 0x3 */
        uint8_t CVL;                                     /*!< Channel Value Low, array offset: 0x7, array step: 0x3 */
      } CV_ACCESS8BIT;
  ...
  union {                                          /* offset: 0x1D */
    struct {                                         /* offset: 0x1D */
      uint8_t CNTINH;                                  /*!< Counter Initial Value High, offset: 0x1D */
      uint8_t CNTINL;                                  /*!< Counter Initial Value Low, offset: 0x1E */
    } CNTIN_ACCESS8BIT;
    uint16_t CNTIN;                                  /*!< FTM0_CNTIN register...FTM1_CNTIN register., offset: 0x1D */
  };
  uint8_t STATUS;                                  /*!< Capture and Compare Status, offset: 0x1F */
  uint8_t MODE;                                    /*!< Features Mode Selection, offset: 0x20 */
  uint8_t SYNC;                                    /*!< Synchronization, offset: 0x21 */
  uint8_t OUTINIT;                                 /*!< Initial State for Channel Output, offset: 0x22 */
  uint8_t OUTMASK;                                 /*!< Output Mask, offset: 0x23 */
  uint8_t COMBINE[3];                              /*!< Function for Linked Channels, array offset: 0x24, array step: 0x1 */
  uint8_t RESERVED_1[1];
  uint8_t DEADTIME;                                /*!< Deadtime Insertion Control, offset: 0x28 */
  uint8_t EXTTRIG;                                 /*!< External Trigger, offset: 0x29 */
  uint8_t POL;                                     /*!< Channels Polarity, offset: 0x2A */
  uint8_t FMS;                                     /*!< Fault Mode Status, offset: 0x2B */
  uint8_t FILTER[2];                               /*!< Input Capture Filter Control, array offset: 0x2C, array step: 0x1 */
  uint8_t FLTFILTER;                               /*!< Fault Input Filter Control, offset: 0x2E */
  uint8_t FLTCTRL;                                 /*!< Fault Input Control, offset: 0x2F */
  uint8_t QDCTRL;                                  /*!< Quadrature Decoder Control and Status, offset: 0x30 */
...
#define FTM_CVH_REG(base,index)                  ((base)->CHANNEL[index].CV_ACCESS8BIT.CVH)
#define FTM_CVL_REG(base,index)                  ((base)->CHANNEL[index].CV_ACCESS8BIT.CVL)
...
/* CVH Bit Fields */
#define FTM_CVH_VAL_H_MASK                       0xFFu
#define FTM_CVH_VAL_H_SHIFT                      0
#define FTM_CVH_VAL_H(x)                         (((uint8_t)(((uint8_t)(x))<<FTM_CVH_VAL_H_SHIFT))&FTM_CVH_VAL_H_MASK)
/* CVL Bit Fields */
#define FTM_CVL_VAL_L_MASK                       0xFFu
#define FTM_CVL_VAL_L_SHIFT                      0
#define FTM_CVL_VAL_L(x)                         (((uint8_t)(((uint8_t)(x))<<FTM_CVL_VAL_L_SHIFT))&FTM_CVL_VAL_L_MASK)
/* CnV Bit Fields */
...
#define FTM0_C0VH                                FTM_CVH_REG(FTM0_BASE_PTR,0)
#define FTM0_C0VL                                FTM_CVL_REG(FTM0_BASE_PTR,0)
#define FTM0_C0V                                 FTM_CnV_REG(FTM0_BASE_PTR,0)
#define FTM0_C1SC                                FTM_CnSC_REG(FTM0_BASE_PTR,1)
#define FTM0_C1VH                                FTM_CVH_REG(FTM0_BASE_PTR,1)
#define FTM0_C1VL                                FTM_CVL_REG(FTM0_BASE_PTR,1)
...
#define FTM1_C0VH                                FTM_CVH_REG(FTM1_BASE_PTR,0)
#define FTM1_C0VL                                FTM_CVL_REG(FTM1_BASE_PTR,0)
#define FTM1_C0V                                 FTM_CnV_REG(FTM1_BASE_PTR,0)
#define FTM1_C1SC                                FTM_CnSC_REG(FTM1_BASE_PTR,1)
#define FTM1_C1VH                                FTM_CVH_REG(FTM1_BASE_PTR,1)
#define FTM1_C1VL                                FTM_CVL_REG(FTM1_BASE_PTR,1)
#define FTM1_C1V                                 FTM_CnV_REG(FTM1_BASE_PTR,1)
#define FTM1_C2SC                                FTM_CnSC_REG(FTM1_BASE_PTR,2)
#define FTM1_C2VH                                FTM_CVH_REG(FTM1_BASE_PTR,2)
#define FTM1_C2VL                                FTM_CVL_REG(FTM1_BASE_PTR,2)
#define FTM1_C2V                                 FTM_CnV_REG(FTM1_BASE_PTR,2)
#define FTM1_C3SC                                FTM_CnSC_REG(FTM1_BASE_PTR,3)
#define FTM1_C3VH                                FTM_CVH_REG(FTM1_BASE_PTR,3)
#define FTM1_C3VL                                FTM_CVL_REG(FTM1_BASE_PTR,3)
#define FTM1_C3V                                 FTM_CnV_REG(FTM1_BASE_PTR,3)
#define FTM1_C4SC                                FTM_CnSC_REG(FTM1_BASE_PTR,4)
#define FTM1_C4VH                                FTM_CVH_REG(FTM1_BASE_PTR,4)
#define FTM1_C4VL                                FTM_CVL_REG(FTM1_BASE_PTR,4)
#define FTM1_C4V                                 FTM_CnV_REG(FTM1_BASE_PTR,4)
#define FTM1_C5SC                                FTM_CnSC_REG(FTM1_BASE_PTR,5)
#define FTM1_C5VH                                FTM_CVH_REG(FTM1_BASE_PTR,5)
#define FTM1_C5VL                                FTM_CVL_REG(FTM1_BASE_PTR,5)
...
#define FTM0_CVH(index)                          FTM_CVH_REG(FTM0_BASE_PTR,index)
#define FTM1_CVH(index)                          FTM_CVH_REG(FTM1_BASE_PTR,index)
#define FTM0_CVL(index)                          FTM_CVL_REG(FTM0_BASE_PTR,index)
#define FTM1_CVL(index)                          FTM_CVL_REG(FTM1_BASE_PTR,index)
...
#define SIM_SCGC2_ANL_MASK                       0x40u
#define SIM_SCGC2_ANL_SHIFT                      6
