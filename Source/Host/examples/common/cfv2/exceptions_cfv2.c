...
#if(defined(PIT0_ISR_USED) && (defined(__MCF52259_H__) || defined(__MCF52221_H__)))
   PIT0_ISR,           /* 119 (0x___) Reserved                   */
#else
   asm_exception_handler,           /* 119 (0x___) Reserved                   */
#endif
#if(defined(__MCF52259_H__) || defined(__MCF52221_H__)) 
   Timer_ISR            ,           /* 120 (0x___) Reserved                   */
#else   
