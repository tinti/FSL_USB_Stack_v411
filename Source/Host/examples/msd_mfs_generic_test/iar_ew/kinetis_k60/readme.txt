...
=============
  ...
  The example project is compatible with Freescale TWR-K60N512 board.
...
===============
  ...
  2) Select File->Open->Workspace...
     Open the following workspace:
      ...
      Source\Host\examples\msd_mfs_generic_test\iar_ew\kinetis_k60\MSD_FAT_FS_GENERIC_TEST.eww
