...
=============
  ...
  The example project is compatible with Freescale TWR-K20D72M board.
  By default, the project is configured to use the P&E OS-JTAG interface.
 
CONFIGURATION
=============
  The Workspace contains USB MSD FAT-FS GENERIC TEST example with the following configuration:
  
  Flash Debug K20D7: The example is flashed to embedded flash memory.
...
===============
  ...
  2) Select File->Open->Workspace...
     Open the following workspace:
      ...
      Source\Host\examples\msd_mfs_generic_test\iar_ew\kinetis_k20d7\MSD_FAT_FS_GENERIC_TEST.eww
