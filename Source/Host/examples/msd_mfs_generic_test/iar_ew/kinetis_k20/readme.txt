...
=============
  ...
  The example project is compatible with Freescale TWR-K20D50M board.
...
=============
  ...
  Flash Debug K20: The example is flashed to embedded flash memory.
...
===============
  ...
  2) Select File->Open->Workspace...
     Open the following workspace:
      ...
      Source\Host\examples\msd_mfs_generic_test\iar_ew\kinetis_k20\MSD_FAT_FS_GENERIC_TEST.eww
