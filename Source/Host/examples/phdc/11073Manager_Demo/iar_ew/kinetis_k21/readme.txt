...
CONFIGURATION
=============
  The Workspace contains USB PHDC host example with the following configuration:
...
===============
  ...
  2) Select File->Open->Workspace...
     Open the following workspace:
      ...
      Source\Host\examples\phdc\11073Manager_Demo\iar_ew\kinetis_k21\USBH_PHDC.eww
