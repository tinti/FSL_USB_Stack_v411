...
CONFIGURATION
=============
  The Workspace contains USB HID keyboard Host example with the following configuration:
...
===============
  ...
  2) Select File->Open->Workspace...
     Open the following workspace:
      ...
      Source\Host\examples\hid\keyboard\iar_ew\kinetis_k20d7\USBH_HIDKBD.eww
