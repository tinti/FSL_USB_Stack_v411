...
typedef struct {
	...
	tIsrFunc __fun[0x77];
		...
		extern void USBHS_OTG_ISR(void);
	#else
		extern void USB_OTG_ISR(void);
	#endif
#else
		extern void USB_ISR();
#endif
#ifdef USE_IRQ_PTA
extern void IRQ_ISR_PTA(void);
#endif
#ifdef USE_IRQ_PTB
extern void IRQ_ISR_PTB(void);
#endif
#ifdef USE_IRQ_PTC
extern void IRQ_ISR_PTC(void);
#endif
#ifdef USE_IRQ_PTD
extern void IRQ_ISR_PTD(void);
#endif
#ifdef USE_IRQ_PTE
extern void IRQ_ISR_PTE(void);
#endif
#ifdef USE_PIT0
...
void Cpu_INT_Hard_FaultInterrupt(void)
{
}
...
const __declspec(vectortable) tVectorTable __vector_table = { /* Interrupt vector table */
	...
	(uint32_t *)__SP_INIT,						/* 0x00  0x00000000   -   ivINT_Initial_Stack_Pointer    used by PE */
	{
		...
		(tIsrFunc)Cpu_INT_Hard_FaultInterrupt,	/* 0x03  0x0000000C   -1   ivINT_Hard_Fault               unused by PE */
	...
	#else
		(tIsrFunc)USB_OTG_ISR,					/* 0x59  0x00000164   -   ivINT_USB0                     unused by PE */
	#endif
#else
...
#ifdef USE_IRQ_PTA
		(tIsrFunc)IRQ_ISR_PTA,					/* 0x67  0x0000019C   -   ivINT_PORTA                    unused by PE */
#else
		(tIsrFunc)Cpu_Interrupt,				/* 0x67  0x0000019C   -   ivINT_PORTA                    unused by PE */
#endif
#ifdef USE_IRQ_PTB
		(tIsrFunc)IRQ_ISR_PTB,					/* 0x68  0x000001A0   -   ivINT_PORTB                    unused by PE */
#else
		(tIsrFunc)Cpu_Interrupt,				/* 0x68  0x000001A0   -   ivINT_PORTB                    unused by PE */
#endif
#ifdef USE_IRQ_PTC
		(tIsrFunc)IRQ_ISR_PTC,					/* 0x69  0x000001A4   -   ivINT_PORTC                	   unused by PE */
#else
		(tIsrFunc)Cpu_Interrupt,				/* 0x69  0x000001A4   -   ivINT_PORTC                    unused by PE */
#endif
#ifdef USE_IRQ_PTD
		(tIsrFunc)IRQ_ISR_PTD,					/* 0x6A  0x000001A8   -   ivINT_PORTD                    unused by PE */
#else
		(tIsrFunc)Cpu_Interrupt,				/* 0x6A  0x000001A8   -   ivINT_PORTD                    unused by PE */
#endif
#ifdef USE_IRQ_PTE
		(tIsrFunc)IRQ_ISR_PTE,					/* 0x6B  0x000001AC   -   ivINT_PORTE                    unused by PE */
#else
...
#if HIGH_SPEED_DEVICE && OTG_BUILD
		(tIsrFunc)USBHS_OTG_ISR,				/* 0x70  0x000001C0   -   ivINT_Reserved112              unused by PE */
#else
