...
#ifdef USE_PIT0
   (tIsrFunc)Timer_ISR,           	  /* 0x2E  0x000000B8   -   ivINT_PIT0                     PIT0_ISR     */
#else 
...
#ifdef OTG_BUILD
   (tIsrFunc)USB_OTG_ISR,           	/* 0x33  0x000000CC   -   ivINT_USB0                     USB_OTG_ISR */
#else
...
#endif
#ifdef USE_IRQ_PTA
   (tIsrFunc)IRQ_ISR_PTA,             /* 0x38  0x000000E0   -   ivINT_PORTA                    IRQ_ISR_PTA */
#else
...
#ifdef USE_IRQ_PTC
   (tIsrFunc)IRQ_ISR_PTC,             /* 0x3A  0x000000E8   -   ivINT_PORTC                	   IRQ_ISR_PTC */
#else
...
#ifdef USE_IRQ_PTE
   (tIsrFunc)IRQ_ISR_PTE,             /* 0x3C  0x000000F0   -   ivINT_PORTE                    IRQ_ISR_PTE */
#else
