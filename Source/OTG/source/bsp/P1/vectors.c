...
#ifdef USE_PIT0
   (tIsrFunc)Timer_ISR,           	  /* 0x54  0x00000150   -   ivINT_PIT0                     Timer_ISR    */
#else 
   (tIsrFunc)Cpu_Interrupt,           /* 0x54  0x00000150   -   ivINT_PIT0                     unused by PE */
#endif
#ifdef USE_PIT1
   (tIsrFunc)PIT1_ISR,           	    /* 0x55  0x00000154   -   ivINT_PIT1                     PIT1_ISR     */
#else 
...
#ifdef OTG_BUILD
   (tIsrFunc)USB_OTG_ISR,           	/* 0x59  0x00000164   -   ivINT_USB0                     USB_OTG_ISR  */
#else
   (tIsrFunc)USB_ISR,           	    /* 0x59  0x00000164   -   ivINT_USB0                     USB_ISR      */
#endif
...
#ifdef USE_LPT
   (tIsrFunc)Timer_ISR,               /* 0x65  0x00000194   -   ivINT_LPTimer                  Timer_ISR    */
#else
...
#ifdef USE_IRQ_PTA
   (tIsrFunc)IRQ_ISR_PTA,             /* 0x67  0x0000019C   -   ivINT_PORTA                    IRQ_ISR_PTA  */
#else
   (tIsrFunc)Cpu_Interrupt,           /* 0x67  0x0000019C   -   ivINT_PORTA                    unused by PE */
#endif
#ifdef USE_IRQ_PTB
   (tIsrFunc)IRQ_ISR_PTB,             /* 0x68  0x000001A0   -   ivINT_PORTB                    IRQ_ISR_PTB  */
#else
   (tIsrFunc)Cpu_Interrupt,           /* 0x68  0x000001A0   -   ivINT_PORTB                    unused by PE */
#endif
#ifdef USE_IRQ_PTC
   (tIsrFunc)IRQ_ISR_PTC,             /* 0x69  0x000001A4   -   ivINT_PORTC                	   IRQ_ISR_PTC  */
#else
...
#ifdef USE_IRQ_PTE
   (tIsrFunc)IRQ_ISR_PTE,             /* 0x6B  0x000001AC   -   ivINT_PORTE                    IRQ_ISR_PTE  */
#else
