...
#ifdef OTG_BUILD
        (tIsrFunc)USB_OTG_ISR,             /* 0x28  0x000000A0   -   ivINT_USB0                     USB_ISR      */
#else
...
#ifdef USE_IRQ_PTA
 		(tIsrFunc)IRQ_ISR_PTA,           	/* 0x2E  0x000000B8   -   ivINT_PORTA                    unused by PE */
#else
        (tIsrFunc)Cpu_Interrupt,           /* 0x2E  0x000000B8   -   ivINT_PORTA                    unused by PE */
#endif
#ifdef USE_IRQ_PTD
		(tIsrFunc)IRQ_ISR_PTD,           	/* 0x2F  0x000000BC   -   ivINT_PORTD                    unused by PE */
#else
