...
#endif         
#ifdef USE_IRQ_PTA
extern void IRQ_ISR_PTA();
#endif 
#ifdef USE_IRQ_PTC
extern void IRQ_ISR_PTC();
#endif 
...
#ifdef OTG_BUILD
        (tIsrFunc)USB_OTG_ISR,              /* 0x45  0x00000114   -ivINT_USB0                         USB_ISR      */
#else
...
#if defined USE_IRQ_PTA
        (tIsrFunc)IRQ_ISR_PTA,           	/* 0x4B  0x0000012C   -ivINT_PORTA                        IRQ_ISR_PORTA */
#else
...
#if defined USE_IRQ_PTC
        (tIsrFunc)IRQ_ISR_PTC,           	/* 0x4D  0x00000134   -ivINT_PORTC                        IRQ_ISR_PORTC */
#else
        (tIsrFunc)Cpu_Interrupt,           	/* 0x4D  0x00000134   -ivINT_PORTC                        IRQ_ISR_PORTC */
#endif
