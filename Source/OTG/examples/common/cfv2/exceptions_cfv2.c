...
#ifdef OTG_BUILD
extern void  __declspec(interrupt) USB_OTG_ISR(void);
#else
extern __declspec(interrupt) void USB_ISR(void);
#endif
...
extern __declspec(interrupt) void UART1_ISR(void);
	...
	extern __declspec(interrupt) void PIT0_ISR(void);
#endif
#if(defined(__MCF52259_H__) || defined(__MCF52221_H__)) 
	extern __declspec(interrupt) void PIT1_ISR(void);
#endif
#if(defined(__MCF52259_DEMO_) || defined(__MCF52221_H__)||defined(__MCF52259_TW_)) 
	extern __declspec(interrupt) void IRQ_ISR(void);
#endif

#if(defined(__MCF52259_EVB_)) 
	extern __declspec(interrupt) void DTIM0_ISR(void);
#endif
...
__declspec(vectortable) vectorTableEntryType _vect[256] = {   /* Interrupt vector table */
...
#if(defined(__MCF52259_H__) || defined(__MCF52221_H__)) 
   UART1_ISR            ,           /*  78 (0x138) Device-specific interrupts */
#else   
   ...
   UART1_ISR            ,           /*  91 (0x16C) Device-specific interrupts */
#else
...
#if(defined(OTG_BUILD))
   USB_OTG_ISR        	,       	/* 117 (0x___) Reserved                   */
#else
   USB_ISR              ,       	/* 117 (0x___) Reserved                   */
#endif   
