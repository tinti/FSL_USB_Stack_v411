 ...
 *****************************************************************************/
#ifndef __SD_kinetis__
#define __SD_kinetis__
...
/* Prototypes */
extern uint_8 SD_Init(void);
extern uint_8 SD_SendCommand(uint_8,uint_8);
extern void   SD_CLKDelay(uint_8);
extern void   SD_Write_Block(PTR_LBA_APP_STRUCT);
extern void   SD_Read_Block(PTR_LBA_APP_STRUCT);
extern uint_8 SD_ReadCSD(void);
