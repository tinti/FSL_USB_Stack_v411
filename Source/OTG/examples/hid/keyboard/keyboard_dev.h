...
#define  PAGEDOWN_PRESS        (0x02) /* Page DOWN Key Press */
#define  SPACE_PRESS           (0x04) /* Space Bar Press */
#define  PRTSCRN_PRESS         (0x08) /* Print Screen Press */
/*****************************************************************************
 * Global variables
 *****************************************************************************/
extern volatile uint_8 kbi_stat; /* records the status of the buttons (PTG0-PTG3)
...
extern void App_PeripheralKbiServiceRoutine(void);
