...
=============
  ...
  The example project is compatible with Freescale TWR-K53 board.
  By default, the project is configured to use the P&E USB Multilink interface.
 
CONFIGURATION
=============
  The Workspace contains OTG HID example with few configurations.
...
===============
  ...
  2) Select File->Open->Workspace...
     Open the following workspace:
      ...
      OTG\examples\hid\keyboard\audio_generator\iar_ew\kinetis_k53\OTG_HID.eww

  3) Connect the P&E USB Multilink
