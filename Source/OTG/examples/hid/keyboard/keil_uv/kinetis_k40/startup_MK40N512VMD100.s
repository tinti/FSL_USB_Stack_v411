...
__Vectors       DCD     __initial_sp  ; Top of Stack
                ...
                DCD     Timer_ISR  ; PIT timer channel 0 interrupt
                DCD     PIT1_ISR  ; PIT timer channel 1 interrupt
                DCD     PIT2_IRQHandler  ; PIT timer channel 2 interrupt
                DCD     PIT3_IRQHandler  ; PIT timer channel 3 interrupt
                DCD     PDB0_IRQHandler  ; PDB0 Interrupt
                DCD     USB_OTG_ISR  ; USB0 interrupt
                ...
                DCD     IRQ_ISR_PTB  ; Port B interrupt
                DCD     IRQ_ISR_PTC  ; Port C interrupt
...
PIT1_ISR 	PROC
                ...
                ENDP
USB_OTG_ISR 	PROC
                EXPORT  USB_OTG_ISR           		[WEAK]
                B       .
                ENDP
Timer_ISR		PROC
                EXPORT  Timer_ISR           [WEAK]
                B       .
                ENDP
IRQ_ISR_PTB 	PROC
                EXPORT  IRQ_ISR_PTB           [WEAK]
                B       .
                ENDP
IRQ_ISR_PTC 	PROC
                EXPORT  IRQ_ISR_PTC           [WEAK]
                B       .
                ENDP
