 ...
 static void Kbi_Init(void)
{
    ...
    */
	...
	/* M52259TW: SW1, SW2, connected to PTA[0 - 1] */
	/* Configure PTA[0 - 1] as input */
	MCF_GPIO_DDRTA	&= ~(MCF_GPIO_DDRTA_DDRTA0 |MCF_GPIO_DDRTA_DDRTA1); /* set input PTA0 PTA1 */
	MCF_GPIO_PTAPAR = (MCF_GPIO_PTAPAR_ICOC0_GPIO | MCF_GPIO_PTAPAR_ICOC1_GPIO); /* set GPIO */ 
...
uint_32 App_PeripheralInit(void)
{
    ...
    kbi_stat=0x00;
    Int_Ctl_int_init(PIT0_INT_CNTL, PIT0_ISR_SRC, 2,2, TRUE); /* enable interrupt pit 0 for timer */
    DisableInterrupts;
    #if (defined _MCF51MM256_H) || (defined _MCF51JE256_H)
     usb_int_dis();
    #endif
    ...
    #endif
    App_PeripheralKbiServiceRoutine() ; /* start sample the key pad */
...
{       
    ...
    /* Uninitialize the USB interface */
     ...
     MCF_USB_OTG_TOKEN = 0;
     MCF_USB_OTG_ENDPT0  = 0;
     MCF_USB_OTG_ENDPT1  = 0;
     MCF_USB_OTG_ENDPT2  = 0;
     MCF_USB_OTG_ENDPT3  = 0;
     MCF_USB_OTG_ENDPT4  = 0;
     MCF_USB_OTG_ENDPT5  = 0;
     MCF_USB_OTG_ENDPT6  = 0;
     MCF_USB_OTG_ENDPT7  = 0;
     MCF_USB_OTG_ENDPT8  = 0;
     MCF_USB_OTG_ENDPT9  = 0;
     MCF_USB_OTG_ENDPT10  = 0;
     MCF_USB_OTG_ENDPT11  = 0;
     MCF_USB_OTG_ENDPT12  = 0;
     MCF_USB_OTG_ENDPT13  = 0;
     MCF_USB_OTG_ENDPT14  = 0;
     MCF_USB_OTG_ENDPT15  = 0;
     MCF_USB_OTG_ADDR = 0;
     RemoveTimerQ(0); /* remove timer object */
     MCF_RTC_RTCIENR = 0x00;
     MCF_RTC_RTCISR = 0x01;
...
void App_PeripheralTask(void)
{
       ...
       if((start_kbi_debounce_tmr) && (kbi_debounce_tmr == TIMER_NOT_STARTED))
       {
         ...
         TimerObject.msCount = 200; /* 200ms count */
